...
const SecondSection = () => {
  ...
  return (
    <div className="p-10 pt-20 mobile:p-5">
      <div className="p-5 pt-0 pb-0 brown-gradient flex tablet:flex-col mobile:flex-col">
        <div className=" text-white w-3/6 tablet:w-full mobile:w-full">
          ...
          >
            <div
              className="flex justify-between pb-2 mobile:flex-col"
        ...
        <div className="w-3/6 pl-3 tablet:w-full mobile:w-full">
          <div className="mobile:w-full">
            <h4 className="text-white gilda text-7xl pt-12 animate-fade tablet:text-8xl mobile:text-4xl mobile:pt-6">
            ...
            <div className="text-white mt-10 animate-fade mobile:w-full mobile:mt-5">
            ...
            <div className="pb-0 pr-7 mt-14">
              <div
                className="flex flex-col w-3/5 justify-self-end mobile:w-full "
                style={{ border: "1px solid #822C17" }}
              >
                <div className="flex justify-between p-5">
                  <p className="text-2xl text-white mobile:text-lg">
                    Hand made Earrings
                    <br />
                    Creative Design
                  </p>
