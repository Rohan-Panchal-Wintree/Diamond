  ...
  return (
    <div className="p-4 pt-20">
      <div className="flex justify-center pb-16 animate-fade">
        <h4 className="text-Peach-Puff text-6xl relative gilda capitalize animate-fade mobile:text-4xl">
      ...
      <div className="flex p-4 tablet:flex-col mobile:flex-col">
        <div className="w-6/12 text-white px-4 tablet:flex tablet:w-full mobile:w-full">
          <div className="tablet:self-center">
            ...
            <div className="flex capitalize pt-3 mobile:flex mobile:flex-col mobile:items-start">
              ...
              <button className="capitalize rounded-full border px-3 py-1.5 ml-5 mobile:ml-0 mobile:mt-4">
                diamonds
              </button>
            </div>
          </div>
        ...
        <div className="w-full flex flex-col justify-center pb-7 tablet:pt-10 mobile:pb-0">
          <div className="flex justify-center h-full mobile:flex-col">
            <div className="brown-gradient-reverse w-2/5 relative mobile:w-full mobile:mt-5">
            ...
            <div>
              <div className="text-Peach-Puff p-16 pt-24 pr-0 mobile:p-0 mobile:pb-3 mobile:pt-3">
                <p className="pb-1">World famous</p>
                <h4 className="text-3xl capitalize mobile:text-2xl">
                  gold necklace
                </h4>
              </div>
            </div>
          ...
          <div className="relative animate-fade">
            <h4
              className="gilda text-Peach-Puff text-6xl absolute mobile:text-3xl"
              style={{
      ...
      <div className="flex justify-between mt-16 px-7 pb-14 tablet:flex-col tablet:pt-14 mobile:flex-col mobile:px-0 mobile:mt-7">
        ...
        <div className="flex items-center mt-7 p-4 text-white tablet:flex-col tablet:items-start mobile:flex-col mobile:items-start">
          <img
            className="w-14"
      ...
      <div className="p-4 py-9 mx-11 mt-10 flex flex-col justify-center brown-gradient relative overflow-hidden mobile:mx-0 mobile:py-4 mobile:mt-0">
        <h4 className="text-8xl gilda text-white text-center tablet:text-6xl z-20 mobile:text-3xl">
          Personalised jewellery
        </h4>
        <br />
        <h4 className="flex justify-center text-8xl gilda text-white text-center tablet:text-6xl mobile:text-3xl mobile:-mt-4">
          designed
          <img
            className="w-48 -mt-40 -mx-3 object-fit z-10 tablet:-mx-6 mobile:w-28 mobile:object-contain mobile:-mt-24"
